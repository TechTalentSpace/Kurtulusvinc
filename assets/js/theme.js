...
$(document).ready(function(){
	...
	if ( heroSliderExists ) {
		...
		var heroCarousel = $( '#sk__hero-carousel-slider:not(.sk__static-carousel-slider)' );
		...
		// Video bitene kadar carousel'i durdur ve video bitince sonraki slide'a geç
		var heroVideo1103 = document.getElementById('hero-video-1103');
		if (heroVideo1103 && heroCarousel.length) {
			// Video oynarken carousel'i durdur
			heroVideo1103.addEventListener('play', function() {
				heroCarousel.carousel('pause');
			});

			// Video bitince sonraki slide'a geç ve carousel'i devam ettir
			heroVideo1103.addEventListener('ended', function() {
				heroCarousel.carousel('next');
				// Video bitince carousel otomatik geçişe devam etsin
				setTimeout(function() {
					heroCarousel.carousel({
						ride: "carousel",
						pause: false,
